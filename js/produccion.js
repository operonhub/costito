    ...
    body.innerHTML = [
      ...
      '<div class="card">',
        ...
        '<div id="ping-header" class="ping-header">',
          '<span>Ingrediente</span><span>Cantidad</span><span>$ Paquete</span><span>Rinde</span><span>Costo</span><span></span>',
        '</div>',
      ...
      '<div class="card" style="margin-top:16px">',
        ...
        '</div>',
        '<div class="field">',
          '<label>Unidades producidas por tanda</label>',
    ...
    list.innerHTML = ingredientes.map((ing) => [
      '<div class="ping-row" data-ing-id="' + ing.id + '">',
        ...
        '<div class="ping-pkt">',
          ...
          '<input class="in-bare ping-unit" type="text" placeholder="g" value="' + esc(ing.unidad) + '" data-field="unidad" />',
        '</div>',
        '<div class="ping-pkt">',
        ...
        '<div class="ping-pkt">',
          ...
          '<input class="in-bare ping-unit" type="text" placeholder="g" value="' + esc(ing.unidadRinde) + '" data-field="unidadRinde" />',
        '</div>',
